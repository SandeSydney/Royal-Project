...
Public Class FrmHome
    ...
    Private Sub btnAdd_Click(sender As Object, e As EventArgs) Handles btnAdd.Click
        ...
        sqlQuery = "INSERT INTO garments(garmentId, customerId, type, color, quantity, dispatched) 
                        VALUES('" & txtGarmentId.Text & "','" & txtCustomerId.Text & "','" & txtType.Text & "','" & txtColor.Text & "','" & txtQuantity.Text & "','" & cmbDispatched.Text & "')"
        SaveData(sqlQuery)
    ...
    Private Sub dgvGarment_CellClick(sender As Object, e As DataGridViewCellEventArgs) Handles dgvGarment.CellClick
        ...
        Try
            ...
            txtColor.Text = dgvGarment.SelectedRows(0).Cells(3).Value.ToString
    ...
    Private Sub btnLogout_Click(sender As Object, e As EventArgs) Handles btnLogout.Click
        'when the logout button is clicked, remove the form from focus
        Me.Close()
    End Sub

    Private Sub btnViewAddCust_Click(sender As Object, e As EventArgs) Handles btnViewAddCust.Click
        ' when the button has been clicked, this will create a Customer Form
